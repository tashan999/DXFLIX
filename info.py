...
# ============================
SESSION = environ.get('SESSION', 'NEXXXTFLIX')   # Session name for the bot
API_ID = int(environ.get('API_ID', '22890220')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '189bf7fcc78634328ee3b49ccfa7ef96')  # API Hash from my.telegram.org
...
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/bf5a9f1843f5d15b99bac-7b6f4a57cffa20c2d7.jpg')).split()  # Fsub pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002906737714 -1002735590722 -1001864717260').split()]  # Channel id for auto indexing (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002917195715')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+rMOVuYQNpBE3NmM1')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002997132826 -1001674674258")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://ibb.co/4nnZTRk9')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'rzzzz0080@axl')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tashanrp:tashanrp@databasesec.5fk0zb6.mongodb.net/?retryWrites=true&w=majority&appName=DatabaseSec")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "akshat") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'tzcollection2') # Collection name (default: dreamcinezone_files)

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "True"), True) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://codexflix:codexflix@cluster0.alkmsk4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003010902792'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003279392247')) #Verification Channel Id 
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/htolnextflix")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/htolnextflix")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/htolnextflix")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "68156c1e0de7a57f3aef0e2dcbdc3168ed6b9040") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arolinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "68156c1e0de7a57f3aef0e2dcbdc3168ed6b9040")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "arolinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "5b04c132725e67bbe36e8f00e76ef4bf39d45cf5")  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+VKLy83iFurg4NjRl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/tazenx_bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+uWZfk-0Sg3UwYTdl') # Update channel link for the bot
