...
<blockquote>‣ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/tazenx_bot">ᴛᴀᴢᴇɴ x</a></blockquote>
"""

    GSTART_TXT = """<blockquote><b>ʜᴇʟʟᴏ {} 👋</b></blockquote>
...
✨ ʜᴏᴡ ᴛᴏ ʀᴇǫᴜᴇꜱᴛ ᴍᴏᴠɪᴇꜱ, ᴅʀᴀᴍᴀꜱ & ᴀɴɪᴍᴇ ✨

1️⃣ ꜱᴇᴀʀᴄʜ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ᴛɪᴛʟᴇ ᴏɴ ɢᴏᴏɢʟᴇ.
2️⃣ ꜱᴇɴᴅ ᴛʜᴇ ᴛɪᴛʟᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
3️⃣ ᴜꜱᴇ ᴛʜɪꜱ ꜰᴏʀᴍᴀᴛ:

📌 ꜰᴏʀ ꜱᴇʀɪᴇꜱ / ᴅʀᴀᴍᴀꜱ:
➤ ᴛɪᴛʟᴇ + S01 (ᴄʜᴀɴɢᴇ ᴛᴏ S02, S03 ᴀꜱ ɴᴇᴇᴅᴇᴅ)

📌 ꜰᴏʀ ʜɪɴᴅɪ ᴅʀᴀᴍᴀꜱ:
➤ ᴛɪᴛʟᴇ + ʜɪɴᴅɪ

📌 ꜰᴏʀ ᴍᴏᴠɪᴇꜱ:
➤ ᴍᴏᴠɪᴇ ᴛɪᴛʟᴇ + ʏᴇᴀʀ (ᴇx: ᴊᴏᴋᴇʀ 2019)

📌 ꜰᴏʀ ᴀɴɪᴍᴇ:
➤ ᴀɴɪᴍᴇ ᴛɪᴛʟᴇ + ᴀʀᴄ / ꜱᴇᴀꜱᴏɴ / ᴍᴏᴠɪᴇ ᴛʏᴘᴇ
(ᴇx: ᴅᴇᴍᴏɴ ꜱʟᴀʏᴇʀ – ᴍᴜɢᴇɴ ᴛʀᴀɪɴ)
